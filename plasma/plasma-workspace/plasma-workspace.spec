%global commit0 2711ff41ff181aecf6c0bb8bb45a015911bae7ae
...
Obsoletes:      kgamma < %{version}-%{release}
Obsoletes:      kcm_wacomtablet < %{version}-%{release}
...
%{_kf6_datadir}/kxmlgui5/kfontviewpart/kfontviewpart.rc
