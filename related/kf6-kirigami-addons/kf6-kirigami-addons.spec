%global commit0 9a6e5a03d304c2c380606adf5d0ca8cf829027d5
...
Version:        1.13.1%{?bumpver:^%{bumpver}.git%{shortcommit0}}
Release:        1%{?dist}
...
%doc README.md
%license LICENSES/
%{_kf6_libdir}/libKirigamiAddonsComponents.so.%{version_no_git}
